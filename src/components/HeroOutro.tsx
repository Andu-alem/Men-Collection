    ...
    return (
        <div className="relative h-screen w-full bg-[url('/background/collection.jpg')] bg-cover relative">
            ...
            <div className="absolute top-0 w-full h-full flex flex-col justify-center items-center">
                <p 
                    className="text-[20px] md:text-[30px] text-orange-500 w-10/12 sm:w-3/5 my-5 text-center tracking-wide font-light leading-7"
                ...
                <Button variant="outline" className="text-white bg-black group" asChild>
                    <span className="flex">
                        <Link href="/products">Shop Now</Link>
                        <ChevronRightIcon className="text-orange-400 ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-1" />
                    </span>
                </Button>
            </div>
            <DotPattern
